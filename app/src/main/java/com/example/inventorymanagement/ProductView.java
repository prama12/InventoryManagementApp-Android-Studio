...
public class ProductView extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setTitle("Product Deletion\n");
        builder.setMessage(p.getProduct_name()+ " 'Are you sure you want to delete?");
        ...
        builder.setPositiveButton("YEAH", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(check == 1){
                    Toast toast = Toast.makeText(ProductView.this, "The product has been deleted!", Toast.LENGTH_LONG);
                    ...
                    Toast toast = Toast.makeText(ProductView.this, "The product could not be deleted!", Toast.LENGTH_LONG);
                    View view = toast.getView();
