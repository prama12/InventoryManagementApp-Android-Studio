    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(error > 0){
                    Toast toast = Toast.makeText(ProductUpdate.this, "Product Failed to Update!", Toast.LENGTH_SHORT);
                    ...
                    if(check == 1){     //update success
                        Toast toast = Toast.makeText(ProductUpdate.this, "The product has been updated!!", Toast.LENGTH_SHORT);
                        View view = toast.getView();
                        ...
                        Toast toast = Toast.makeText(ProductUpdate.this, "The product could not be updated!!", Toast.LENGTH_SHORT);
                        View view = toast.getView();
                        view.getBackground().setColorFilter(Color.parseColor("#ff2b2b"),PorterDuff.Mode.SRC_IN);
