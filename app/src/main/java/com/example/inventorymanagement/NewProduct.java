    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_product_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(error > 0){
                    Toast toast = Toast.makeText(NewProduct.this, "The product could not be added!", Toast.LENGTH_SHORT);
                    ...
                    if(check == 1){     //add success
                        ...
                        description.setText("");
                        quantity.setText("");
                        Toast toast = Toast.makeText(NewProduct.this, "Product added!", Toast.LENGTH_SHORT);
                        View view = toast.getView();
